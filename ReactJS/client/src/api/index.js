...
const API = axios.create({ baseURL: 'https://reactprojectupsmart.herokuapp.com/' });

API.interceptors.request.use((req) => {   //sending token to middlewares
...
export const fetchEmpdata = (id) => API.get(`/add/${id}/empdata`);
